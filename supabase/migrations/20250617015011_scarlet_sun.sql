/*
  ...
  2. Changes
    ...
    - Auth users need to be created separately via Supabase Auth API
    - This migration only handles the public user profiles

  3. Notes
    - The actual auth users should be created via the application signup process
    - These records will be linked when users sign up with matching emails
*/
